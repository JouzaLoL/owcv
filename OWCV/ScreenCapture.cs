...
namespace OWCV
{
    ...
    public static class ScreenCaptureSinglePixel
    {

    //    public static Bitmap GetSinglePixel(IntPtr hwnd)
    //    {
    ...
    //                int retval = BitBlt(hDC, 0, 0, 1, 1, hSrcDC, xVal, 540, CopyPixelOperation.SourceCopy);
    //                gdest.ReleaseHdc();
    //                gsrc.ReleaseHdc();
