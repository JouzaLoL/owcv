    ...
    public class DesktopDuplicator
    {
        ...
        public DesktopDuplicator(int whichGraphicsCardAdapter, int whichOutputDevice)
        {
            ...
            this.mTextureDesc = new Texture2DDescription()
            {
                ...
                Width = this.mOutputDesc.DesktopBounds.Left - this.mOutputDesc.DesktopBounds.Right,
                Height = this.mOutputDesc.DesktopBounds.Top - this.mOutputDesc.DesktopBounds.Bottom,
